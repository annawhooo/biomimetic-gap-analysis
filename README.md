...
- **18** biologically-derived attack scenarios with paired defensive mitigations
- **7** immune failure modes with safeguards identifying which design principles are at risk
- **3** framework compliance mappings (NIST CSF 2.0, OWASP LLM Top 10 2025, MITRE ATT&CK)
- **1** feasibility assessment grading all 18 scenarios against MCP and LangChain
